...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll active" href="registration/venue.php">Chocolate cakes</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/theme.php">Birthday Cakes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/music.php">Wedding Cakes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/catering.php">Brownies</a>
          </li>
           <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/photoshop.php">Cup Cakes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/decoration.php">Desserts</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="checkbooking.php">Check Orders</a>
          </li>
          <li class="nav-item">
  ...
  <!--/ Intro Skew End /-->
  <h2 class="text-center mt-5">Confirmed orders</h2>
  <br>
     ...
     <div class="card">
       <div class="card-header bg-info">
         <div class="row">
           ...
           <div class="col-md-2">Finished Date</div>
